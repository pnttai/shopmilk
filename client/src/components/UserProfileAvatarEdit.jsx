  ...
  return (
    ...
    bg-opacity-60 p-4 flex items-center justify-center'>
        ...
        items-center justify-center'>
                <button onClick={close} className='text-eutral-800 w-fit block ml-auto'>
                    <IoClose size={20} />
                </button>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className='border border-primary-200 cursor-pointer hover:bg-primary-200
                              px-4 py-1 rounded text-sm m-3'> UpLoad
                              {
