...
const ProductDisplayPage = () => {
  ...
  data.discount ? (
    ...
    <p className="font-bold text-green-600 lg:text-m ">Không giảm giá</p>
            ...
            <h2 className='font-semibold'>Tại sao nên mua sắm tại ShopMilk? </h2>
            <div>
                  <div className='flex  items-center gap-4 my-4'>
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Nhận đơn hàng được giao đến tận nhà bạn sớm nhất từ ​​các cửa hàng tiện lợi gần bạn.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Điểm đến giá tốt nhất với ưu đãi trực tiếp từ nhà sản xuất.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      />
                      <div className='text-sm'>
                        <div className='font-semibold'>Sự đa dạng</div>
                        <p>Lựa chọn từ hơn 5000 sản phẩm thuộc nhiều danh mục thực phẩm, chăm sóc cá nhân, gia dụng và các danh mục khác.</p>
                      </div>
                  </div>
            </div>
