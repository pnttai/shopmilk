...
const UploadProduct = () => {
  ...
  // useEffect(()=>{
  //   successAlert("Tạo sản phẩm thành công")
  // },[])
  ...
  return (
    ...
    <div className='grid p-3'>
      <form action="" className='grid gap-4' onSubmit={handleSubmit}>
        ...
        <div className='grid gap-1'>
          <label htmlFor="description" className='font-medium'>Miêu tả sản phẩm</label>
        ...
        <div className='grid gap-1'>
          <label htmlFor="" className='font-medium'>Danh muc</label>
          <div>
            <select name="" id="" 
        ...
        <div className='grid gap-1'>
          <label htmlFor="" className='font-medium'> Mô tả danh muc</label>
          <div>
            <select name="" id="" 
            ...
            >
              ...
              <option value={""} className='text-neutral-600'>Lựa chọn mô tả  danh mục</option>
              {
        ...
        <div className='grid gap-1'>
          <label htmlFor="unit" className='font-medium'>đơn vị sản phẩm</label>
          <input id='unit'
              type="text" 
        ...
        <div className='grid gap-1'>
          ...
          <input id='stock'
              type="number" 
              placeholder='Nhập stock  sản phẩm'
              value={data.stock}
              name='stock'
              onChange={handleChange}
              required
        ...
        <div className='grid gap-1'>
          ...
          <input id='discount'
              type="number" 
              placeholder='Nhập sản phẩm Giảm giá'
              value={data.discount}
              name='discount'
              onChange={handleChange}
              required
        ...
        <div onClick={()=>setOpenAddField(true)} className='hover:bg-primary-200bg-white py-1 px-3 w-32 text-center font-semibold border border-primary-200 hover:text-neutral-900 cursor-pointer rounded'>
                  add fields
        </div>
    ...
    {
        ViewImageURL && (
          <ViewImageURL url={ViewImageURL} close={()=>setViewImageURL("")}/>
        )
    }
    {
      openAddField && (
